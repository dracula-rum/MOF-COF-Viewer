  ...
  <el-container direction="vertical" class="bg">
    ...
    <el-row gutter=2 style="margin-top: 15px;">
      <el-col :span="11">
        ...
        <!-- Structure -->
        <el-table :data="table1" border stripe style="width: 100%" size="small" :table-layout="fixed" v-if="selectedMenu === 'Structure'">
        ...
        <div v-if="selectedMenu.includes('Mixing')">
          <div v-if="hasData_hun == 'true'">
            <el-table :data="table3_1" border style="width: 100%" size="small" :table-layout="fixed" v-if="selectedMenu.includes('ch4')">
              ...
              <el-table-column prop="name2" label="属性" width="170%"/>
              <el-table-column prop="data" label="数值" />
              <el-table-column prop="danwei" label="单位" width="100%"/>
            </el-table>
...
<script setup>
  ...
  const searchMol = ref(props.name);
  //
  const name=ref('')
  const file_path=ref('')
  const file_type=ref('')
    ...
    try {
      response = await axios.get(
        ...
        },
        {
          name1: 'CH₄_Qst⁰',
          name2: 'CH₄的吸附热',
          data: property_rd.value.CH4_Qst,
          danwei: 'KJ/mol',
        },
        {
          name1: 'CH₄_Ds',
        ...
        },
        {
          name1: 'C₂H₆_Qst⁰',
          name2: 'C₂H₆的吸附热',
          data: property_rd.value.C2H6_Qst,
          danwei: 'KJ/mol',
        },
        {
          name1: 'C₂H₆_Ds',
        ...
        },
        {
          name1: 'C₂H₄_Qst⁰',
          name2: 'C₂H₄的吸附热',
          data: property_rd.value.C2H4_Qst,
          danwei: 'KJ/mol',
        },
        {
          name1: 'C₂H₄_Ds',
        ...
        },
        {
          name1: 'C₃H₈_Qst⁰',
          name2: 'C₃H₈的吸附热',
          data: property_rd.value.C3H8_Qst,
          danwei: 'KJ/mol',
        },
        {
          name1: 'C₃H₈_Ds',
        ...
        },
        {
          name1: 'C₃H₆_Qst⁰',
          name2: 'C₃H₆的吸附热',
          data: property_rd.value.C3H6_Qst,
          danwei: 'KJ/mol',
        },
        {
          name1: 'C₃H₆_Ds',
